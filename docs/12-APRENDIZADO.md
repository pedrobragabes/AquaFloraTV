...
→ Ancora em decisão real do Retail Signage. "No Retail Signage resolvi parecido — tinha que [problema similar], e a abordagem foi [decisão]".
...
- [ ] **Primeira experiência com cliente externo** — lidar com responsável pela operação como usuário real
...
- ⭐ **Fase 3 concluída**: responsável pela operação consegue operar o sistema sozinho
